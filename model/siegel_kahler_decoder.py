...
class SiegelDecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        # Normalizasyon katmanları - PoincareBall kullan
        self.norm_self_attn = geoopt.manifolds.PoincareBall().proj_manifold(
            nn.LayerNorm(latent_dim)
        )
        self.norm_cross_attn = geoopt.manifolds.PoincareBall().proj_manifold(
            nn.LayerNorm(latent_dim)
        )
        self.norm_ffn = geoopt.manifolds.PoincareBall().proj_manifold(
            nn.LayerNorm(latent_dim)
        )
